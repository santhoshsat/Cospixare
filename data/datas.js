export const homeData = [
    {
        ...
        description: 'Leverage analytics to make informed decisions and drive business growth.'
    },
    {
        icon: '🔒',
        title: 'Top-Notch Security',
        description: 'Military-grade encryption and cybersecurity solutions to protect your assets.'
    },
    {
        icon: '⚡',
        title: 'High Performance',
        description: 'Optimized solutions ensuring speed, scalability, and seamless performance.'
    },
    {
        icon: '🤖',
        title: 'AI-Powered Solutions',
        description: 'Innovative AI & ML integrations to enhance productivity and automation.'
    }
]
